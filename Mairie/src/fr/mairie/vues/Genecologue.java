...
public class Genecologue extends JPanel {
	...
	public Genecologue(){
		super() ;
		System.out.println("Genecologue::Constructor");
		//this.ctrlBouton.setInitActivite("");
		//this.ctrlBouton.setInitActivite(jeux);
		modeleTabSanteA = new ModeleSanteAssoc("Genecologue") ;
		this.creerInterfaceVisiteurs() ;
	}
	
	private void creerInterfaceVisiteurs(){
		
		System.out.println("Genecologue::creerInterfaceVisiteurs()");
		
		Box boxPrincipale = Box.createVerticalBox() ;
		Box boxEtiquette = Box.createHorizontalBox() ;
		Box boxTable = Box.createHorizontalBox() ;
		
		boxEtiquette.add( new JLabel( "Genecologue" ) ) ;
...
//////////A l'origine seuls les getters etaient présent ci-après/////////////////	
	public ModeleSanteAssoc getModeleListeGenecologue() {
